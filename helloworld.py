...
iterFruits = ("apple", "banana", "cherry")

myIt = iter(iterFruits)
...
nameString = "Awais Tasleem"

nameIt = iter(nameString)
...
print(next(nameIt))
print(next(nameIt))
#print(next(nameIt))  this will cause an error because the next item is null
...
class MyNumbersClass:
      ...
      def __iter__(self):
            self.a = 1  #initilising a with 1
            return self
      
      def __next__(self):
            """
            #This will go on forever or the number of time next() is called
            x = self.a  #gets the latest number of a
            self.a += 1 #adds 1 to a
            return x    #returns x
            """

            if self.a <= 20:  #checks to see if self.a is 20
                  x = self.a
                  self.a += 1
                  return x
            else:
                  raise StopIteration #this stops it
      

myClass = MyNumbersClass()
...
print(next(myItter))
print(next(myItter))
#print(next(myItter)) This would cause an error because self.a is greater than 20
